...
const ABI = [
    ...
    "function games(uint256) view returns (uint256 gameId, address playerWhite, address playerBlack, string fen, uint256 lastMoveTimestamp, uint256 betAmount, bool isWhiteTurn, uint8 status)",
